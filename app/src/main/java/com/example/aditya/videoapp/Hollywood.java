...
public class Hollywood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Hollywood");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<mApps,mViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<mApps,mViewHolder>(
            ...
            protected void populateViewHolder(mViewHolder viewHolder, mApps model, int position){
                ...
                final String post_add ="Blog";
                viewHolder.setImage(getApplicationContext(),model.getImage());

                viewHolder.mView.setOnClickListener( new View.OnClickListener(){
                                                         @Override
                                                         public void onClick(View view) {
                                                             Intent intent=new Intent (Hollywood.this,trialActivity.class);
