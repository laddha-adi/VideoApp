...
*/
    ...
    protected void onStart() {
        ...
        super.onStart();
        FirebaseRecyclerAdapter<mApps,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<mApps,BlogViewHolder>(
                mApps.class,R.layout.list_row,BlogViewHolder.class,mDatabase
        ){
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, mApps model, int position){
                ...
                viewHolder.mView.setOnClickListener( new View.OnClickListener(){
                                                         ...
                                                         public void onClick(View view) {
                                                             Intent intent=new Intent (List.this,trialActivity.class);
...
Picasso.with(ctx).load(Image).into(post_image);
    ...
    /*likeBtn.setOnClickListener(new View.OnClickListener() {
        ...
        finalChoice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finalChoice.setVisibility(View.INVISIBLE);
                if(choice==1){
